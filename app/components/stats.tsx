...
const Stats = () => {
  return (
    <section className="p-6 my-6 dark:bg-gray-800 dark:text-gray-100 flex-col items-center">
      <h2 className="text-3xl font-extrabold py-8 text-center">Technologies I am Experience In</h2>
