...
const ExperienceCard = () => {
  return (
    <div className="xl:container m-auto px-6 py-20 md:px-12 lg:px-20">
      ...
      <div className="m-auto mt-12 items-center justify-center space-y-4 lg:flex lg:space-y-0 lg:space-x-4 xl:w-12/12">
          ...
          <div className="relative sm:flex">
                  ...
                  <ul className="flex h-full w-max justify-center space-x-2 px-6 sm:w-full sm:flex-col sm:space-x-0 sm:space-y-6 sm:px-8">
                    ...
                    <li>
                      <div className="relative">
                        ...
                        <div
                          aria-hidden="true"
                          className="absolute inset-x-0 bottom-[-1.7rem] z-[1] mx-auto h-6 w-6 scale-0 rounded-full border-8 border-white dark:border-gray-800 bg-primary transition peer-checked:scale-100 sm:inset-y-0 sm:left-[-2.70rem] sm:my-auto sm:ml-0"
                        ></div>
                      </div>
                    </li>
                    <li>
            ...
            <div className="space-y-8 p-8 pb-20 sm:w-7/12 sm:pb-8">
              ...
              <div className="absolute inset-x-0 bottom-6 w-full px-6 sm:static sm:px-0">
                <button className="relative flex h-11 w-full items-center justify-center px-6 before:absolute before:inset-0 before:rounded-full before:bg-primary-600 before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95">
