      ...
      <div className="container flex flex-col items-center px-4 py-16 mx-auto xl:flex-row">
        ...
        <div className="flex flex-col items-center mt-6 xl:items-start xl:w-1/2 xl:mt-0">
          ...
          <p className="block max-w-2xl mt-4 text-gray-500 dark:text-gray-300">
            Hello! My name is Ajay Verma and I enjoy creating things that live on the internet.I
            possess a strong command of a wide array of technologies, including JavaScript, Node.js,
            Express, Nest.js, React.js, Java, Spring, Spring Boot, Angular, Microservices, Mongodb,
            Posgresql, sequalize . With years of hands-on experience in this field, I've honed my
            ability to create high-quality software solutions. My expertise extends to software
            design and development, particularly in crafting robust data structures and
            product-oriented designs. I'm passionate about learning new technologies and frameworks,
            continually expanding my technical skill set. I tackle real-world challenges with
            analytical reasoning, breaking them down into logical components to develop effective,
            scalable solutions..{' '}
          </p>
