...
export const ContactSection = () => {
  return (
    <>
      <section className="relative z-10 overflow-hidden bg-white py-20 dark:bg-inherit lg:py-[120px]">
        <div className="container">
          <div className="-mx-4 flex flex-wrap lg:justify-between">
            <div className="lg:w-1/2 lg:mx-6 flex flex-col justify-center">
    ...
    <>
      <div className="mb-6">
        <input
          ...
          placeholder={placeholder}
          name={name}
          className="w-full rounded border border-stroke px-[14px] py-3 text-base text-body-color outline-none focus:border-primary dark:border-gray-900 dark:bg-gray-700 dark:text-dark-6"
        />
      </div>
    </>
  );
